...
const tools = [
  {
    ...
    desc: "11-slide interactive setup guide for the perfect Claude Code environment. Context architecture, vibecoding rules, Docker MCP.",
...
export default function ToolsSection() {
  return (
    <section className="px-12 pb-[100px]" id="tools">
